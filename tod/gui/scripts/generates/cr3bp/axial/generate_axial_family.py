"""generate_axial_family 的 GUI 参数注册。
...
SCRIPT_ENTRY = ScriptEntry(
    ...
    description='在地月 CR3BP 中生成 Axial 轨道族，用于后续转移搜索、轨道分析或任务设计。脚本读取 GUI 中填写的延拓范围、步长和延拓方法等参数。结果保存到 output/axial，通常包含带时间戳的轨道 JSON 和 latest 副本。',
