...
SCRIPT_ENTRY = ScriptEntry(
    ...
    cli_params=[
        ...
        CliParam('--direction', '延拓方向', 'str', 'both', help='延拓方向，默认 both（从种子向振幅更小和更大双向铺开）。', choices=('positive', 'negative', 'both'), choice_values={'positive': 'positive', 'negative': 'negative', 'both': 'both'}, hidden_when='--method==pseudo_arclength'),
