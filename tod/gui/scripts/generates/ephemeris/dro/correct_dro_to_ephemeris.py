"""correct_dro_to_ephemeris 的 GUI 参数注册。
...
SCRIPT_ENTRY = ScriptEntry(
    ...
    description='修正单条轨道',
    script_path='tod/generates/ephemeris/correct_dro_to_ephemeris.py',
    output_dir='output/ephemeris',
    needs_spice=True,
    group_label='星历转换',
    cli_params=[
        CliParam('--input-file', '星历转换输入文件', 'str', '', help='单条轨道或轨道族 JSON 文件路径。', file_category='dro'),
