...
验证点：FigureCanvasQTAgg 嵌入 PyQt6 主窗口后，交互（缩放/平移/旋转）是否流畅。
"""

from __future__ import annotations

import matplotlib
matplotlib.use("Agg")  # noqa: E402 — 必须在 pyplot 导入前设置非交互后端

# CJK 字体回退（复用现有模块）
from tod.plot._font_config import apply_cjk_font_fallback
