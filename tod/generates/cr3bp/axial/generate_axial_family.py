...
def parse_args(argv=None):
    ...
    """
    parser = argparse.ArgumentParser(description="生成 Axial 轨道族", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    parser.add_argument("--amplitude-z-min", type=float, default=0.01, help="z 方向最小振幅")
    parser.add_argument("--amplitude-z-max", type=float, default=0.5, help="z 方向最大振幅")
