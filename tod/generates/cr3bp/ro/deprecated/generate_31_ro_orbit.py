...
运行示例:
    .. code-block:: bash
       ...
       uv run python -m tod.generates.cr3bp.ro.generate_31_ro_orbit --help
"""
...
def parse_args():
    ...
    Returns:
        解析后的命令行参数命名空间。
    """
    parser = argparse.ArgumentParser(description="生成 3:1 RO 轨道（固定周期微分校正）", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
