...
SCRIPT_ENTRY = ScriptEntry(
    ...
    cli_params=[
        ...
        CliParam('--n-departure', 'GEO 出发点数', 'int', '10', help='GEO 出发点数量。'),
        CliParam('--n-alpha', 'alpha 密度', 'int', '200', help='alpha 网格密度。'),
        CliParam('--alpha-min', 'alpha 下界', 'float', '1.0', help='alpha 搜索下界。'),
        CliParam('--alpha-max', 'alpha 上界', 'float', '1.5', help='alpha 搜索上界。'),
        CliParam('--max-transfer-time', '最大转移时间', 'float', '28.719127', help='最大转移时间（无量纲）。', unit_group='time', default_unit='days'),
        CliParam('--intersection-threshold', '相交阈值', 'float', '0.00026', help='相交判定距离阈值，单位 km。', unit_group='distance', default_unit='km'),
