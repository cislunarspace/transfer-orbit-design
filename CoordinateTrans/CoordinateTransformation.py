...
if __name__ == "__main__":
    ...
    r_GCRS = np.array(
        [
            [105191834906.9699, -47973262639.33333, 101134600819.1729],
            [105191834906.9699, -47973262639.33333, 101134600819.1729],
        ]
    )
    v_GCRS = np.array(
        [
            [-16516.89234682873, 254265.786803117, 137792.6412136556],
            [-16516.89234682873, 254265.786803117, 137792.6412136556],
        ]
    )
    ...
    r_EMR = np.array(
        [
            [58474488700.00002, 87576237100.00002, 111830675000],
            [58474488700.00002, 87576237100.00002, 111830675000],
        ]
    )
    v_EMR = np.array(
        [
            [0.9554907300043851, 0.8312989600235596, 0.6575268000160577],
            [0.9554907300043851, 0.8312989600235596, 0.6575268000160577],
        ]
    )
    ...
    r_MI = np.array(
        [
            [105191607084.1139, -47972996882.92648, 101134744965.5356],
            [105191607084.1139, -47972996882.92648, 101134744965.5356],
        ]
    )
    v_MI = np.array(
        [
            [-16517.70368481344, 254265.2118708625, 137792.3301597261],
            [-16517.70368481344, 254265.2118708625, 137792.3301597261],
        ]
    )
    ...
    r_GCRS = np.array(
        [
            [103714428500.92839, -69695568040.31377, 89335371846.69431],
            [103714428500.92839, -69695568040.31377, 89335371846.69431],
        ]
    )
    v_GCRS = np.array(
        [
            [50741.14337391643, 50741.14337391643, 133644.7304307124],
            [50741.14337391643, 50741.14337391643, 133644.7304307124],
        ]
    )
