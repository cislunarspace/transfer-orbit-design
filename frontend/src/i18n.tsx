...
export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    "updater.manual_download_action": "前往下载页",
    "updater.in_app_unsupported": "deb/rpm 安装暂不支持应用内更新，已打开版本发布页，请手动下载安装新版本。",
    "updater.error": "更新失败",
  ...
  en: {
    ...
    "updater.manual_download_action": "Open Download Page",
    "updater.in_app_unsupported": "In-app updates are not available for deb/rpm installs. The releases page has been opened — please download and install the new version manually.",
