...
export const translations: Record<string, Record<string, string>> = {
  ...
  en: {
    ...
    "canvas.frame.inertial_km_idealized": "geocentric inertial (km, idealized θ₀=0)",
    "canvas.controlled_ephemeris": "Controlled ephemeris",
    "canvas.frame.synodic_unavailable": "synodic geometry, not drawable in the inertial view",
    "canvas.orbit_list": "Canvas orbits",
    ...
    "updater.installing": "Installing update — enter your administrator password in the system prompt…",
    "updater.installed_title": "Installation Complete",
    "updater.installed_desc": "The new version has been installed. Restart the app to apply it.",
    "updater.open_releases": "Open Download Page",
    ...
    "panel.tab.orbit_info": "Orbit info",
    "orbit_info.empty": "Click an orbit in the canvas orbit list (left), or pick one on the canvas, to view its details here",
    "orbit_info.kind": "Type",
    "orbit_info.frame": "Data frame",
    "orbit_info.jacobi": "Jacobi constant",
    "orbit_info.points": "Points",
    "orbit_info.time_span": "Time span",
    "orbit_info.time_none": "untimed",
    "orbit_info.source": "Source",
    "orbit_info.source.pinned": "Pinned record",
    "orbit_info.source.candidate": "Transfer candidate",
    "orbit_info.source.result": "Latest run product",
    "run.execute": "Run",
