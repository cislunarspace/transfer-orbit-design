...
from tod.commons.paths import ensure_output_dir, find_project_root, safe_resolve_within
...
class TestFindProjectRoot:
    ...
    def test_from_source_file(self):
        """Should find project root from the paths.py source file"""
        project_root = Path(__file__).resolve().parents[3]
        source_file = project_root / "tod" / "commons" / "paths.py"
