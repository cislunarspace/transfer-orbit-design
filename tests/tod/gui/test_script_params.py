...
PARAMS_FILES = [
    ...
    "generates/cr3bp/ro/generate_31_ro_orbit.py",
    "generates/cr3bp/ro/generate_31_ro_family.py",
    "generates/cr3bp/ro/generate_32_ro_family.py",
    "generates/cr3bp/ro/generate_aro_family.py",
    "generates/cr3bp/ro/generate_rro_family.py",
    # Transfer
