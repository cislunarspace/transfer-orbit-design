...
PLOT_FONT_ENV_VARS: dict[str, str] = {key: f"PLOT_FONT_{key.upper()}" for key in PLOT_FONT_KEYS}

PLOT_FONT_SETTING_KEYS: dict[str, str] = {key: f"plot_font_{key}" for key in PLOT_FONT_KEYS}
