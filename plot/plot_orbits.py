...
运行示例:
    .. code-block:: bash
       ...
       uv run python -m plot.plot_orbits --json-file output/halo/family.json --view-2d
       uv run python -m plot.plot_orbits \\
           --json-file '[{"path": "a.json"}, {"path": "b.json"}]' --view-3d --plane xz
"""
...
from plot.orbit_config_registry import FALLBACK_CONFIG, detect_orbit_config
from plot.orchestrator import (
    FamilyPlotConfig,
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="绘制轨道的间隔步长，1 表示绘制全部（仅单文件模式有效）",
    )
