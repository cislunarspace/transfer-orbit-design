...
从轨道族JSON文件中提取T/T_moon ≈ 3.0的共振轨道。

用法:
    python extract_31_ro_orbit.py
"""
...
#   - 具体文件: "ro_31_family_-0.9305--0.8304999999999999-0.001_3856908879.json"
#   - glob模式: "ro_31_family_*.json"
INPUT_FILE = "ro_31_family_*.json"
# =============================================================================

INPUT_PATTERN = str(OUTPUT_DIR / "ro" / INPUT_FILE)

output_base = OUTPUT_DIR / ORBIT_TYPE / "31"
...
if DRY_RUN:
    ...
    for i, match in enumerate(all_matching_orbits):
        ...
        output_filename = f"{ORBIT_TYPE}_31_{period_ratio_str}_idx{match['orbit_index']}_{timestamp}.json"
