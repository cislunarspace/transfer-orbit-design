"""
提取3:2远距逆行轨道(DRO) - 32周期比

从轨道族JSON文件中提取T/T_moon ≈ 1.5的远距逆行轨道。

用法:
    python extract_32_dro_orbit.py
"""
...
INPUT_FILE = "dro_family_*.json"
# =============================================================================

INPUT_PATTERN = str(OUTPUT_DIR / "dro" / INPUT_FILE)
