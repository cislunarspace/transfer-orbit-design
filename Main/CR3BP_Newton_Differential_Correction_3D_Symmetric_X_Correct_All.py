...
def CR3BP_Newton_Differential_Correction_3D_Symmetric_X_Correct_All(
    SV0_initial, tf_initial, tol, N, maxiter
):
    """
    定义微分修正方法，利用牛顿迭代法修正关于x轴对称的周期轨道初值，同时修正x0,y0_dot,z0_dot和周期T（适用于Axial轨道）
    ...
    while True:
        ...
        # 定义微分校正系数矩阵, dF = [[phi_21, phi_25, phi_26, y_dot],[phi_31, phi_35, phi_36, z_dot],[phi_41, phi_45, phi_46, x_ddot]]
