...
def CR3BP_Newton_Differential_Correction_3D_Symmetric_XZ_Fixed_Z0(
    SV0_initial, tf_initial, tol, N, maxiter
):
    """
    定义微分修正方法，利用牛顿迭代法修正关于xz平面对称的周期轨道初值，固定z0，修正x0,y0_dot和周期T（适用于Halo轨道，Vertical轨道）
    ...
    while True:
        ...
        # 定义微分校正系数矩阵, dF = [[phi_21, phi_25, y_dot],[phi_41, phi_45, x_ddot],[phi_61, phi_65, z_ddot]]
